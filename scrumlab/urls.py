...
urlpatterns = [
    ...
    # path('recipe/add/', views.app_add_recipe),                -  odchaczylem bo nie działał mi add_recipe
    path('recipe/modify/<int:id>/', views.app_edit_recipe),
    path('plan/<int:id>/', views.app_details_schedules),
    # path('plan/add/', views.add_app_add_schedules),          -  odchaczylem bo nie działał mi add_plan
